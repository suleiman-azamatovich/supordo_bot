...
Ты — ведущий эксперт по **grammY** и **TypeScript**. Пишешь чистый, расширяемый код с документацией на русском языке.
...
- **Просрочка:** 10 сом/мин после истечения грейса возврата
